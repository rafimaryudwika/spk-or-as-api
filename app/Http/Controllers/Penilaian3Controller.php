...
use App\Services\Penilaian3Service;
use Illuminate\Support\Facades\Validator;
use Symfony\Component\HttpFoundation\Response;

class Penilaian3Controller extends Controller
{
    protected $penilaian3Service;

    public function __construct(Penilaian3Service $penilaian3)
    {
        $this->penilaian3Service = $penilaian3;
    }
    ...
    public function index()
    {
        ...
        return $this->penilaian3Service->getAllData();
    }
    ...
    public function import()
    {
        ...
        //     ]);
        // }
        return $this->penilaian3Service->import();
    }
    ...
    public function lulus(Request $request, $id)
    {
        ...
        //     ]);
        // }
        return $this->penilaian3Service->lulus($request, $id);
    }
    ...
    public function store(Request $request)
    {
        ...
        // }
        return $this->penilaian3Service->requestData($request);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->penilaian3Service->requestData($request, $id);
    }
    ...
    public function show($id)
    {
        ...
        // ];
        // return response()->json($response, Response::HTTP_OK);
        return $this->penilaian3Service->getDataByNim($id);
    }
}
