...
use App\Services\SubKriteria2Service;
use Illuminate\Database\QueryException;
use Illuminate\Support\Facades\Validator;

class SubKriteria2Controller extends Controller
{
    protected $SubKriteria2Service;

    public function __construct(SubKriteria2Service $subk)
    {
        $this->SubKriteria2Service = $subk;
    }
    /**
    ...
    public function index()
    {
        ...
        return $this->SubKriteria2Service->getAllData();
    }
    ...
    public function transpose()
    {
        ...
        $response = [
            'message' => 'Data sub-kriteria tahap 2 OR',
            'data' => $data
        ];
    ...
    public function store(Request $request)
    {
        ...
        // }
        return $this->SubKriteria2Service->requestData($request);
    }
    ...
    public function show($id)
    {
        ...
        // return response()->json($response, Response::HTTP_OK);
        return $this->SubKriteria2Service->getDataById($id);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->SubKriteria2Service->requestData($request, $id);
    }
    ...
    public function destroy($id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->SubKriteria2Service->delete($id);
    }
}
