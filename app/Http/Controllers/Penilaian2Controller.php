...
use App\Services\Penilaian2Service;
use Illuminate\Support\Facades\Validator;
use Symfony\Component\HttpFoundation\Response;

class Penilaian2Controller extends Controller
{
    protected $penilaian2Service;

    public function __construct(Penilaian2Service $penilaian2)
    {
        $this->penilaian2Service = $penilaian2;
    }
    ...
    public function index()
    {
        ...
        return $this->penilaian2Service->getAllData();
    }
    ...
    public function import()
    {
        ...
        //     ]);
        // }
        return $this->penilaian2Service->import();
    }
    ...
    public function lulus(Request $request, $id)
    {
        ...
        //     ]);
        // }
        return $this->penilaian2Service->lulus($request, $id);
    }
    ...
    public function store(Request $request)
    {
        ...
        // }
        return $this->penilaian2Service->requestData($request);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->penilaian2Service->requestData($request, $id);
    }
    ...
    public function show($id)
    {
        ...
        // ];
        // return response()->json($response, Response::HTTP_OK);
        return $this->penilaian2Service->getDataByNim($id);
    }
}
