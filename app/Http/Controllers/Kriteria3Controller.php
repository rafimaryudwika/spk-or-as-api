...
use App\Services\Kriteria3Service;
use Illuminate\Database\QueryException;
use Illuminate\Support\Facades\Validator;

class Kriteria3Controller extends Controller
{
    protected $kriteria3Service;

    public function __construct(Kriteria3Service $krit)
    {
        $this->kriteria3Service = $krit;
    }
    public function index()
    {
        ...
        return $this->kriteria3Service->getAllData();
    }
    ...
    public function store(Request $request)
    {
        ...
        // }
        return $this->kriteria3Service->requestData($request);
    }
    ...
    public function show($id)
    {
        ...
        // return response()->json($response, Response::HTTP_OK);
        return $this->kriteria3Service->getDataById($id);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->kriteria3Service->requestData($request, $id);
    }
    ...
    public function destroy($id)
    {
        ...
        //     ], Response::HTTP_INTERNAL_SERVER_ERROR);
        // }
        return $this->kriteria3Service->delete($id);
    }
}
