...
class Kriteria1Service
{
    use ResponseAPI;
    protected $kriteria;
    public function __construct(Kriteria1Repository $kriteria)
    {
    ...
    public function getAllData()
    {
        try {
            ...
            return $this->success("Data tahap 1 OR XI", $kriteria);
        } catch (Exception $e) {
    ...
    public function getDataById($id)
    {
        try {
            ...
            return $this->success("Data salah satu kriteria tahap 1 OR XI", $kriteria);
        } catch (Exception $e) {
            if (!$e->getCode() || $e->getCode() === 0) return response()->json($e->__toString(), 500);
            return $this->error($e->getMessage(), $e->getCode());
        }
